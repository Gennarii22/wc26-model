...
const I18N = {
 it:{
  ...
  "d.tab_ante":"Antepost","d.tab_gironi":"Gironi","d.tab_partite":"Partite","d.tab_bomber":"Capocannoniere",
  ...
  "d.foot_bomber":"Modello: quota-gol del giocatore nella squadra (rate in nazionale shrinkato per ruolo × titolarità) × gol simulati della squadra. Bankroll e frazione Kelly si impostano nel tab Antepost. Limiti onesti: non vede rigoristi designati né minutaggio reale; per i veterani (Messi 38, Ronaldo 41) non modella il declino — da prendere con cautela.",
  // headers dashboard
 ...
 en:{
  ...
  "d.tab_ante":"Outrights","d.tab_gironi":"Groups","d.tab_partite":"Matches","d.tab_bomber":"Top scorer",
  ...
  "d.foot_bomber":"Model: player's goal share within the team (national-team rate shrunk by role × starting likelihood) × the team's simulated goals. Bankroll and Kelly fraction are set in the Outrights tab. Honest limits: it doesn't see designated penalty takers or real minutes; for veterans (Messi 38, Ronaldo 41) it doesn't model decline — treat with caution.",
